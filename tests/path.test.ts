...
describe(`path`, () => {
    ...
    test('op', () => {
        ...
        builder.close()
        const path = builder.getPath();
        expect(path.toSVGString()).toBe('M50 100C77.58923888895069 100 100 77.58923888895069 100 50C100 22.4107611110493 77.58923888895069 0 50 0C22.4107611110493 0 0 22.4107611110493 0 50C0 77.58923888895069 22.4107611110493 100 50 100Z');
        ...
        builder.close()
        const path1 = builder.getPath();
        // expect(path1.toSVGString()).toBe('M37.5 75C58.191929166713024 75 75 58.191929166713024 75 37.5C75 16.808070833286973 58.191929166713024 0 37.5 0C16.808070833286973 0 0 16.808070833286973 0 37.5C0 58.191929166713024 16.808070833286973 75 37.5 75Z')
